...
private:
    static std::string serializeObject(std::shared_ptr<structure::WSDONObject> object, unsigned int objectDepth, bool toIndentObject);
    static std::string serializeSubObject(std::shared_ptr<structure::WSDONObject::object_type> object, unsigned int objectDepth);
    static std::string serializeArray(std::shared_ptr<structure::WSDONObject::array_type> array, unsigned int objectDepth);
